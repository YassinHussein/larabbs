                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('البريد الاكتروني')
                            }}</label>

                            <div class="col-md-6">
                                <input id="email" type="email" placeholder="البريد الاكتروني " class="form-control
@error('email')
                                        is-invalid
